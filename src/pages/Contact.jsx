...
const Contact = () => {
  ...
  const { loading, error, success } = useSelector((state) => state.message);
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 py-20 px-6 font-sans">
      <div className="max-w-6xl mx-auto">

        {/* Header Section */}
        <div className="mb-12 space-y-2">
          <h1 className="text-4xl md:text-5xl font-bold text-[#0f172a] dark:text-white tracking-tight">
            Get in Touch
          </h1>
          <p className="text-xs md:text-sm font-bold text-slate-500 dark:text-slate-400 uppercase tracking-widest">
            LET'S BRIDGE THE GAP & CREATE SOMETHING EXTRAORDINARY
          </p>
        </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-8 relative z-10">
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="space-y-3">
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 font-bold outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all"
                    />
                  </div>
                  <div className="space-y-3">
                ...
                <div className="space-y-3">
                  ...
                  <textarea
                    ...
                    className="w-full px-6 py-4 rounded-2xl bg-slate-50 dark:bg-slate-800 border border-slate-100 dark:border-slate-700 font-bold outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all resize-none"
                  ></textarea>
                </div>
